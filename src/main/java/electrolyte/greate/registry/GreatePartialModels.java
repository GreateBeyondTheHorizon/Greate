...
public class GreatePartialModels {
    ...
    RUBBER_BELT_ANDESITE_PULLEY = belt(BMS[0],"rubber_belt_andesite_pulley"),
    RUBBER_BELT_STEEL_PULLEY = belt(BMS[0],"rubber_belt_steel_pulley"),
    RUBBER_BELT_START = belt(BMS[0],"rubber_belt_start"), RUBBER_BELT_MIDDLE = belt(BMS[0],"rubber_belt_middle"),
    RUBBER_BELT_END = belt(BMS[0],"rubber_belt_end"), RUBBER_BELT_START_BOTTOM = belt(BMS[0],"rubber_belt_start_bottom"),
    RUBBER_BELT_MIDDLE_BOTTOM = belt(BMS[0],"rubber_belt_middle_bottom"), RUBBER_BELT_END_BOTTOM = belt(BMS[0],"rubber_belt_end_bottom"),
    RUBBER_BELT_DIAGONAL_START = belt(BMS[0],"rubber_belt_diagonal_start"), RUBBER_BELT_DIAGONAL_MIDDLE = belt(BMS[0],"rubber_belt_diagonal_middle"),
    RUBBER_BELT_DIAGONAL_END = belt(BMS[0],"rubber_belt_diagonal_end"),

    SILICONE_RUBBER_BELT_ALUMINIUM_PULLEY = belt(BMS[1],"silicone_rubber_belt_aluminium_pulley"),
    SILICONE_RUBBER_BELT_STAINLESS_STEEL_PULLEY = belt(BMS[1],"silicone_rubber_belt_stainless_steel_pulley"),
    SILICONE_RUBBER_BELT_START = belt(BMS[1],"silicone_rubber_belt_start"), SILICONE_RUBBER_BELT_MIDDLE = belt(BMS[1],"silicone_rubber_belt_middle"),
    SILICONE_RUBBER_BELT_END = belt(BMS[1],"silicone_rubber_belt_end"), SILICONE_RUBBER_BELT_START_BOTTOM = belt(BMS[1],"silicone_rubber_belt_start_bottom"),
    SILICONE_RUBBER_BELT_MIDDLE_BOTTOM = belt(BMS[1],"silicone_rubber_belt_middle_bottom"), SILICONE_RUBBER_BELT_END_BOTTOM = belt(BMS[1],"silicone_rubber_belt_end_bottom"),
    SILICONE_RUBBER_BELT_DIAGONAL_START = belt(BMS[1],"silicone_rubber_belt_diagonal_start"), SILICONE_RUBBER_BELT_DIAGONAL_MIDDLE = belt(BMS[1],"silicone_rubber_belt_diagonal_middle"),
    SILICONE_RUBBER_BELT_DIAGONAL_END = belt(BMS[1],"silicone_rubber_belt_diagonal_end"),

    POLYETHYLENE_BELT_TITANIUM_PULLEY = belt(BMS[2],"polyethylene_belt_titanium_pulley"),
    POLYETHYLENE_BELT_TUNGSTENSTEEL_PULLEY = belt(BMS[2],"polyethylene_belt_tungstensteel_pulley"),
    POLYETHYLENE_BELT_START = belt(BMS[2],"polyethylene_belt_start"), POLYETHYLENE_BELT_MIDDLE = belt(BMS[2],"polyethylene_belt_middle"),
    POLYETHYLENE_BELT_END = belt(BMS[2],"polyethylene_belt_end"), POLYETHYLENE_BELT_START_BOTTOM = belt(BMS[2],"polyethylene_belt_start_bottom"),
    POLYETHYLENE_BELT_MIDDLE_BOTTOM = belt(BMS[2],"polyethylene_belt_middle_bottom"), POLYETHYLENE_BELT_END_BOTTOM = belt(BMS[2],"polyethylene_belt_end_bottom"),
    POLYETHYLENE_BELT_DIAGONAL_START = belt(BMS[2],"polyethylene_belt_diagonal_start"), POLYETHYLENE_BELT_DIAGONAL_MIDDLE = belt(BMS[2],"polyethylene_belt_diagonal_middle"),
    POLYETHYLENE_BELT_DIAGONAL_END = belt(BMS[2],"polyethylene_belt_diagonal_end"),

    POLYTETRAFLUOROETHYLENE_BELT_PALLADIUM_PULLEY = belt(BMS[3],"polytetrafluoroethylene_belt_palladium_pulley"),
    POLYTETRAFLUOROETHYLENE_BELT_NAQUADAH_PULLEY = belt(BMS[3],"polytetrafluoroethylene_belt_naquadah_pulley"),
    POLYTETRAFLUOROETHYLENE_BELT_START = belt(BMS[3],"polytetrafluoroethylene_belt_start"), POLYTETRAFLUOROETHYLENE_BELT_MIDDLE = belt(BMS[3],"polytetrafluoroethylene_belt_middle"),
    POLYTETRAFLUOROETHYLENE_BELT_END = belt(BMS[3],"polytetrafluoroethylene_belt_end"), POLYTETRAFLUOROETHYLENE_BELT_START_BOTTOM = belt(BMS[3],"polytetrafluoroethylene_belt_start_bottom"),
    POLYTETRAFLUOROETHYLENE_BELT_MIDDLE_BOTTOM = belt(BMS[3],"polytetrafluoroethylene_belt_middle_bottom"), POLYTETRAFLUOROETHYLENE_BELT_END_BOTTOM = belt(BMS[3],"polytetrafluoroethylene_belt_end_bottom"),
    POLYTETRAFLUOROETHYLENE_BELT_DIAGONAL_START = belt(BMS[3],"polytetrafluoroethylene_belt_diagonal_start"), POLYTETRAFLUOROETHYLENE_BELT_DIAGONAL_MIDDLE = belt(BMS[3],"polytetrafluoroethylene_belt_diagonal_middle"),
    POLYTETRAFLUOROETHYLENE_BELT_DIAGONAL_END = belt(BMS[3],"polytetrafluoroethylene_belt_diagonal_end"),

    POLYBENZIMIDAZOLE_BELT_DARMSTADTIUM_PULLEY = belt(BMS[4],"polybenzimidazole_belt_darmstadtium_pulley"),
    POLYBENZIMIDAZOLE_BELT_NEUTRONIUM_PULLEY = belt(BMS[4],"polybenzimidazole_belt_neutronium_pulley"),
    POLYBENZIMIDAZOLE_BELT_START = belt(BMS[4],"polybenzimidazole_belt_start"), POLYBENZIMIDAZOLE_BELT_MIDDLE = belt(BMS[4],"polybenzimidazole_belt_middle"),
    POLYBENZIMIDAZOLE_BELT_END = belt(BMS[4],"polybenzimidazole_belt_end"), POLYBENZIMIDAZOLE_BELT_START_BOTTOM = belt(BMS[4],"polybenzimidazole_belt_start_bottom"),
    POLYBENZIMIDAZOLE_BELT_MIDDLE_BOTTOM = belt(BMS[4],"polybenzimidazole_belt_middle_bottom"), POLYBENZIMIDAZOLE_BELT_END_BOTTOM = belt(BMS[4],"polybenzimidazole_belt_end_bottom"),
    POLYBENZIMIDAZOLE_BELT_DIAGONAL_START = belt(BMS[4],"polybenzimidazole_belt_diagonal_start"), POLYBENZIMIDAZOLE_BELT_DIAGONAL_MIDDLE = belt(BMS[4],"polybenzimidazole_belt_diagonal_middle"),
    POLYBENZIMIDAZOLE_BELT_DIAGONAL_END = belt(BMS[4],"polybenzimidazole_belt_diagonal_end"),
