...
public class Saws {
    ...
    public static final BlockEntry<TieredSawBlock> ANDESITE_SAW = saw("andesite_mechanical_saw", ULV, TMS[0], Shafts.ANDESITE_SHAFT, 1.0, GreatePartialModels.ANDESITE_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> STEEL_SAW = saw("steel_mechanical_saw", LV, TMS[1], Shafts.STEEL_SHAFT, 2.0, GreatePartialModels.STEEL_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> ALUMINIUM_SAW = saw("aluminium_mechanical_saw", MV, TMS[2], Shafts.ALUMINIUM_SHAFT, 3.0, GreatePartialModels.ALUMINIUM_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> STAINLESS_STEEL_SAW = saw("stainless_steel_mechanical_saw", HV, TMS[3], Shafts.STAINLESS_STEEL_SHAFT, 4.0, GreatePartialModels.STAINLESS_STEEL_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> TITANIUM_SAW = saw("titanium_mechanical_saw", EV, TMS[4], Shafts.TITANIUM_SHAFT, 5.0, GreatePartialModels.TITANIUM_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> TUNGSTENSTEEL_SAW = saw("tungstensteel_mechanical_saw", IV, TMS[5], Shafts.TUNGSTENSTEEL_SHAFT, 6.0, GreatePartialModels.TUNGSTENSTEEL_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> PALLADIUM_SAW = saw("palladium_mechanical_saw", LuV, TMS[6], Shafts.PALLADIUM_SHAFT, 7.0, GreatePartialModels.PALLADIUM_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> NAQUADAH_SAW = saw("naquadah_mechanical_saw", ZPM, TMS[7], Shafts.NAQUADAH_SHAFT, 8.0, GreatePartialModels.NAQUADAH_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> DARMSTADTIUM_SAW = saw("darmstadtium_mechanical_saw", UV, TMS[8], Shafts.DARMSTADTIUM_SHAFT, 9.0, GreatePartialModels.DARMSTADTIUM_SHAFT_HALF,
    ...
    public static final BlockEntry<TieredSawBlock> NEUTRONIUM_SAW = saw("neutronium_mechanical_saw", UHV, TMS[9], Shafts.NEUTRONIUM_SHAFT, 10.0, GreatePartialModels.NEUTRONIUM_SHAFT_HALF,
