...
public class GreatePonderScenes {
    ...
    public static void register(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        ...
        HELPER.forComponents(GEARBOXES.values()).addStoryBoard(Create.asResource("gearbox"), KineticsScenes::gearbox, AllCreatePonderTags.KINETIC_RELAYS);
        HELPER.forComponents(VERTICAL_GEARBOXES.values()).addStoryBoard(Create.asResource("gearbox"), KineticsScenes::gearbox, AllCreatePonderTags.KINETIC_RELAYS);
