...
public class GreateRecipeConfig {
    ...
    @Configurable
    @Synchronized
    @Comment({"Should certain Create items that have a GTCEu counterpart also be used in recipes?", "If false, GTCEu items will only be used.", "REQUIRES MINECRAFT RESTART"})
