...
public class Greate {
    ...
    public static RegistryEntry<CreativeModeTab> GREATE_TAB = GreateRegistries.REGISTRATE.defaultCreativeTab("greate",
            b -> b
    ...
    private void gatherData(GatherDataEvent event) {
        GreateRegistries.REGISTRATE.addDataGenerator(ProviderType.LANG, p -> {
    ...
    public record GreateRegistrateDisplayItemsGenerator() implements DisplayItemsGenerator {
        ...
        private List<Item> collectBlocks(Predicate<Item> exclusionPredicate) {
            ...
            for(RegistryEntry<Block> entry : GreateRegistries.REGISTRATE.getAll(Registries.BLOCK)) {
                if(!GreateRegistries.REGISTRATE.isInCreativeTab(entry, GREATE_TAB)) continue;
