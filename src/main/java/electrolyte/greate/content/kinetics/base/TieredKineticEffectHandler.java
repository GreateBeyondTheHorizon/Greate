...
public class TieredKineticEffectHandler {


   public int overStressedTime;
   public float overStressedEffect;
   public int particleSpawnCountdown;
   public KineticBlockEntity kte;

    public TieredKineticEffectHandler(KineticBlockEntity kte) {
        this.kte = kte;
    }
