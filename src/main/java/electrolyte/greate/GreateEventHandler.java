...
public class GreateEventHandler {
    ...
    public static void assignShaftTiers(AddReloadListenerEvent event) {
        ...
        Cogwheels.ANDESITE_ENCASED_ANDESITE_COGWHEEL.get().setTier(TIER.ULTRA_LOW);
        Cogwheels.BRASS_ENCASED_ANDESITE_COGWHEEL.get().setTier(TIER.ULTRA_LOW);
        Cogwheels.LARGE_ANDESITE_ENCASED_ANDESITE_COGWHEEL.get().setTier(TIER.ULTRA_LOW);
        Cogwheels.STEEL_COGWHEEL.get().setTier(TIER.LOW);
        Cogwheels.LARGE_STEEL_COGWHEEL.get().setTier(TIER.LOW);
        Cogwheels.ANDESITE_ENCASED_STEEL_COGWHEEL.get().setTier(TIER.LOW);
        Cogwheels.BRASS_ENCASED_STEEL_COGWHEEL.get().setTier(TIER.LOW);
        Cogwheels.LARGE_ANDESITE_ENCASED_STEEL_COGWHEEL.get().setTier(TIER.LOW);
        Cogwheels.ALUMINIUM_COGWHEEL.get().setTier(TIER.MEDIUM);
        Cogwheels.LARGE_ALUMINIUM_COGWHEEL.get().setTier(TIER.MEDIUM);
        Cogwheels.ANDESITE_ENCASED_ALUMINIUM_COGWHEEL.get().setTier(TIER.MEDIUM);
        Cogwheels.BRASS_ENCASED_ALUMINIUM_COGWHEEL.get().setTier(TIER.MEDIUM);
        Cogwheels.LARGE_ANDESITE_ENCASED_ALUMINIUM_COGWHEEL.get().setTier(TIER.MEDIUM);
        Cogwheels.LARGE_BRASS_ENCASED_ALUMINIUM_COGWHEEL.get().setTier(TIER.MEDIUM);
        Cogwheels.STAINLESS_STEEL_COGWHEEL.get().setTier(TIER.HIGH);
        Cogwheels.LARGE_STAINLESS_STEEL_COGWHEEL.get().setTier(TIER.HIGH);
        Cogwheels.ANDESITE_ENCASED_STAINLESS_STEEL_COGWHEEL.get().setTier(TIER.HIGH);
        Cogwheels.BRASS_ENCASED_STAINLESS_STEEL_COGWHEEL.get().setTier(TIER.HIGH);
        Cogwheels.LARGE_ANDESITE_ENCASED_STAINLESS_STEEL_COGWHEEL.get().setTier(TIER.HIGH);
        Cogwheels.TITANIUM_COGWHEEL.get().setTier(TIER.EXTREME);
        Cogwheels.LARGE_TITANIUM_COGWHEEL.get().setTier(TIER.EXTREME);
        Cogwheels.ANDESITE_ENCASED_TITANIUM_COGWHEEL.get().setTier(TIER.EXTREME);
        Cogwheels.BRASS_ENCASED_TITANIUM_COGWHEEL.get().setTier(TIER.EXTREME);
        Cogwheels.LARGE_ANDESITE_ENCASED_TITANIUM_COGWHEEL.get().setTier(TIER.EXTREME);
        Cogwheels.TUNGSTENSTEEL_COGWHEEL.get().setTier(TIER.INSANE);
        Cogwheels.LARGE_TUNGSTENSTEEL_COGWHEEL.get().setTier(TIER.INSANE);
        Cogwheels.ANDESITE_ENCASED_TUNGSTENSTEEL_COGWHEEL.get().setTier(TIER.INSANE);
        Cogwheels.BRASS_ENCASED_TUNGSTENSTEEL_COGWHEEL.get().setTier(TIER.INSANE);
        Cogwheels.LARGE_ANDESITE_ENCASED_TUNGSTENSTEEL_COGWHEEL.get().setTier(TIER.INSANE);
        Cogwheels.PALLADIUM_COGWHEEL.get().setTier(TIER.LUDICRIOUS);
        Cogwheels.LARGE_PALLADIUM_COGWHEEL.get().setTier(TIER.LUDICRIOUS);
        Cogwheels.ANDESITE_ENCASED_PALLADIUM_COGWHEEL.get().setTier(TIER.LUDICRIOUS);
        Cogwheels.BRASS_ENCASED_PALLADIUM_COGWHEEL.get().setTier(TIER.LUDICRIOUS);
        Cogwheels.LARGE_ANDESITE_ENCASED_PALLADIUM_COGWHEEL.get().setTier(TIER.LUDICRIOUS);
        Cogwheels.NAQUADAH_COGWHEEL.get().setTier(TIER.ZPM);
        Cogwheels.LARGE_NAQUADAH_COGWHEEL.get().setTier(TIER.ZPM);
        Cogwheels.ANDESITE_ENCASED_NAQUADAH_COGWHEEL.get().setTier(TIER.ZPM);
        Cogwheels.BRASS_ENCASED_NAQUADAH_COGWHEEL.get().setTier(TIER.ZPM);
        Cogwheels.LARGE_ANDESITE_ENCASED_NAQUADAH_COGWHEEL.get().setTier(TIER.ZPM);
        Cogwheels.DARMSTADTIUM_COGWHEEL.get().setTier(TIER.ULTIMATE);
        Cogwheels.LARGE_DARMSTADTIUM_COGWHEEL.get().setTier(TIER.ULTIMATE);
        Cogwheels.ANDESITE_ENCASED_DARMSTADTIUM_COGWHEEL.get().setTier(TIER.ULTIMATE);
        Cogwheels.BRASS_ENCASED_DARMSTADTIUM_COGWHEEL.get().setTier(TIER.ULTIMATE);
        Cogwheels.LARGE_ANDESITE_ENCASED_DARMSTADTIUM_COGWHEEL.get().setTier(TIER.ULTIMATE);
