...
public class TieredSplitShaftInstance extends KineticBlockEntityInstance<TieredKineticMachineBlockEntity> {
    protected final ArrayList<RotatingData> keys;

    public TieredSplitShaftInstance(MaterialManager modelManager, TieredKineticMachineBlockEntity tile) {
